 ...
 ** \name RTS name for a mission
         This set can be shortened, expanded, or changed for each mission.
         RTS_ID_Spare3 through RTS_ID_Spare256 can be renamed to define
         mission specific command sequences. */
/** \{ */
