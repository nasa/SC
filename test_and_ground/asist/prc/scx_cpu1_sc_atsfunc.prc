...
write ";***********************************************************************"
page SCX_CPU1_SC_HK
page SCX_CPU1_TST_SC_HK
page SCX_CPU1_SC_ATSCMD_TBL
page SCX_CPU1_SC_ATS_TBL
page SCX_CPU1_SC_ATS_APPEND_TBL

write ";***********************************************************************"
write ";  Step 1.3: Create and upload the table load file for RTS #1.  "
write ";***********************************************************************"
s scx_cpu1_sc_loadrts1()

write ";***********************************************************************"
write ";  Step 1.4:  Start the Stored Command (SC) and Test Applications.      "
write ";***********************************************************************"
rts001_started = FALSE
s scx_cpu1_sc_start_apps("1.4")
wait 5
...
if (rts001_started = TRUE) then
  if (SCX_CPU1_SC_CMDPC = 1) AND (SCX_CPU1_SC_CMDEC = 0) AND ;;
     (SCX_CPU1_SC_RTSActvCtr = 1) AND (SCX_CPU1_SC_RTSActvErr = 0) AND ;;
     (SCX_CPU1_SC_RTSCmdCtr = 3) AND (SCX_CPU1_SC_RTSErrCtr = 0) then
    hkGood = TRUE
  endif
else
  if (SCX_CPU1_SC_CMDPC = 0) AND (SCX_CPU1_SC_CMDEC = 1) AND ;;
     (SCX_CPU1_SC_RTSActvCtr = 0) AND (SCX_CPU1_SC_RTSActvErr = 1) AND ;;
     (SCX_CPU1_SC_RTSCmdCtr = 0) AND (SCX_CPU1_SC_RTSErrCtr = 0) then
    hkGood = TRUE
  endif
endif
...
if (hkGood = TRUE) then
  if (SC_CONT_ON_FAILURE_START = TRUE) then
    if (p@SCX_CPU1_SC_ContATSFlag = "Disabled") then
      hkGood = FALSE
    endif
  else
    if (p@SCX_CPU1_SC_ContATSFlag = "Enabled") then
      hkGood = FALSE
    endif
  endif
endif
...
if (hkGood = TRUE) then
  for i = 1 to RTSStatusSize do
    ...
    if (SCX_CPU1_SC_RTSExeStatus[i].RTSStatusEntry.AllStatus <> 0) then
      hkGood = FALSE
    endif

    if (SCX_CPU1_SC_RTSDisableStatus[i].RTSStatusEntry.AllStatus <> disableStatusVal) then
      hkGood = FALSE
    endif
  enddo
endif
...
if (SCX_CPU1_SC_ATSNumber = 0) AND (SCX_CPU1_SC_ATPState = 2) AND ;;
   (SCX_CPU1_SC_ATPCmdNumber = 65536) AND (SCX_CPU1_SC_SwitchPend = 0) AND ;;
   (SCX_CPU1_SC_ActiveRTSs = 0) AND (SCX_CPU1_SC_NextRTS = 0) AND ;;
   (SCX_CPU1_SC_ATSCmdCtr = 0) AND (SCX_CPU1_SC_ATSErrCtr = 0) AND ;;
   (SCX_CPU1_SC_LastATSErr = 0) AND (SCX_CPU1_SC_LastATSCmdErr = 0) AND ;;
   (SCX_CPU1_SC_LastRTSErr = 0) AND (SCX_CPU1_SC_LastRTSCmdErr = 0) AND ;;
   (SCX_CPU1_SC_FreeBytes[1] = freeByteCount) AND ;;
   (SCX_CPU1_SC_FreeBytes[2] = freeByteCount) AND ;;
   (SCX_CPU1_SC_NextRTSTime = x'FFFFFFFF') AND ;;
   (SCX_CPU1_SC_NextATSTime = x'FFFFFFFF') AND ;;
   (p@SCX_CPU1_SC_AppendAtsID = "None") AND ;;
   (SCX_CPU1_SC_AppendCount = 0) AND (SCX_CPU1_SC_AppendSize = 0) AND ;;
   (hkGood = TRUE) then
  ...
  write "CMDPC           = ", SCX_CPU1_SC_CMDPC
  write "CMDEC           = ", SCX_CPU1_SC_CMDEC
  write "RTSs Started    = ", SCX_CPU1_SC_RTSActvCtr
  write "RTSs Started EC = ", SCX_CPU1_SC_RTSActvErr
  write "RTS Command Ctr = ", SCX_CPU1_SC_RTSCmdCtr
  write "RTS Command EC  = ", SCX_CPU1_SC_RTSErrCtr
  write "Cont ATS Flag   = ", p@SCX_CPU1_SC_ContATSFlag
  write "ATS Number      = ", SCX_CPU1_SC_ATSNumber
  write "ATP State       = ", p@SCX_CPU1_SC_ATPState
  write "ATP Command #   = ", SCX_CPU1_SC_ATPCmdNumber
  write "Switch Pending? = ", p@SCX_CPU1_SC_SwitchPend
  write "Active RTSs     = ", SCX_CPU1_SC_ActiveRTSs
  write "Next RTS to run = ", SCX_CPU1_SC_NextRTS
  write "ATS Command Ctr = ", SCX_CPU1_SC_ATSCmdCtr
  write "ATS Command EC  = ", SCX_CPU1_SC_ATSErrCtr
  write "Last ATS w/err  = ", SCX_CPU1_SC_LastATSErr
  write "Last ATS Cmd err= ", SCX_CPU1_SC_LastATSCmdErr
  write "Last RTS w/err  = ", SCX_CPU1_SC_LastRTSErr
  write "Last RTS Cmd err= ", SCX_CPU1_SC_LastRTSCmdErr
  write "ATS A Free Bytes= ", SCX_CPU1_SC_FreeBytes[1]
  write "ATS B Free Bytes= ", SCX_CPU1_SC_FreeBytes[2]
  write "Next RTS Time   = ", %hex(SCX_CPU1_SC_NextRTSTime)
  write "Next ATS Time   = ", %hex(SCX_CPU1_SC_NextATSTime)
  write "Append ATS ID   = ", p@SCX_CPU1_SC_AppendATSID
  write "Append Count    = ", p@SCX_CPU1_SC_AppendCount
  write "Append Size     = ", p@SCX_CPU1_SC_AppendSize

  for i = 1 to RTSStatusSize do
    write "RTS Exe Status[",i,"] = ", %hex(SCX_CPU1_SC_RTSExeStatus[i].RTSStatusEntry.AllStatus,4)
    write "RTS Dis Status[",i,"] = ", %hex(SCX_CPU1_SC_RTSDisableStatus[i].RTSStatusEntry.AllStatus,4)
  enddo
...
/SCX_CPU1_EVS_EnaAppEVTType Application=SCAppName DEBUG
wait 2
...
write ";***********************************************************************"
if (SCX_CPU1_SC_FreeBytes[1] = freeByteCount) AND ;;
   (SCX_CPU1_SC_FreeBytes[2] = freeByteCount) then
  write "<*> Passed (2000) - Both ATS tables are empty and allocated to ",freeByteCount, " bytes."
  ut_setrequirements SC_2000, "P"
else
  write "<!> Failed (2000) - At least one ATS table is not empty or allocated to the desired size. ATS A has ",SCX_CPU1_SC_FREEBYTES[1], "bytes free and ATS B has ",SCX_CPU1_SC_FREEBYTES[2], " bytes free."
...
;; ******* Need to initialize a variable for the end data size
  ...
  s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Empty Table Load", "ats_a_empty_ld",ATSATblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[8000]")

  s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS B Empty Table Load", "ats_b_empty_ld",ATSBTblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[8000]")
endif
...
filename = work & "/image/scx_cpu1_atsa_load.scs"
if NOT file_exists(filename) then
...
compile_ats "scx_cpu1_atsa_load" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load","cpu1_ats_a_load")
...
start load_table ("cpu1_ats_a_load", hostCPU)
...
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_EID, "INFO", 3

cmdCtr = SCX_CPU1_TBL_CMDPC + 1

/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=ATSATblName
...
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS A Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
...
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - SC ATS validation event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=ATSATblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2000.2;2000.3) - ATS A Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
...
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl2_4",hostCPU,atsPktId)
...
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTATS_CMD_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_COMPL_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_NOOP_INF_EID, "INFO", 3
ut_setupevents "SCX", "CPU1", "CFE_TBL", CFE_TBL_NOOP_INF_EID, "INFO", 4
ut_setupevents "SCX", "CPU1", "CFE_EVS", CFE_EVS_NOOP_EID, "INFO", 5
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_ERR_SKP_DBG_EID, "DEBUG", 6

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_StartATS ATSID=1

ut_tlmwait  SCX_CPU1_SC_CMDPC, {cmdCtr}
if (UT_TW_Status = UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTATS_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif

;; Check for the event message indicating the number of 
;; commands skipped when the ATS was started
ut_tlmwait SCX_CPU1_find_event[6].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3000.1) - Expected Event Msg ",SC_ATS_ERR_SKP_DBG_EID," rcv'd."
  ut_setrequirements SC_30001, "P"
else
  write "<!> Failed (3000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ATS_ERR_SKP_DBG_EID,"."
...
currentMET = SCX_CPU1_TIME_STCFSecs + SCX_CPU1_TIME_METSecs
if (SC_TIME_TO_USE = SC_USE_UTC) then
  currentMET = currentMET - SCX_CPU1_TIME_LeapSecs
endif
write "-- CURRENT MET => ", currentMET, " (hex) = ", %hex(currentMET,8)

firstCmdMET = SCX_CPU1_SC_NEXTATSTIME
...
ut_tlmwait  SCX_CPU1_find_event[2].num_found_messages, 1, {waitTime}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - Expected Event Msg ",SC_ATS_COMPL_INF_EID," rcv'd."
else
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ATS_COMPL_INF_EID,"."
endif

;; if the commands executed, it was valid
if (SCX_CPU1_find_event[3].num_found_messages = 1) AND ;;
   (SCX_CPU1_find_event[4].num_found_messages = 1) AND ;;
   (SCX_CPU1_find_event[5].num_found_messages = 1) then
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_CONT_CMD_DEB_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_ContinueATS stop
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_CONT_CMD_DEB_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_ContinueATS continue
...
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_load2.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_18
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_load2" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load2","cpu1_ats_a_load2")
...
start load_table ("cpu1_ats_a_load2", hostCPU)
...
atsBTimes[1] = SCX_CPU1_TIME_STCFSecs + SCX_CPU1_TIME_METSecs + 310
atsBTimes[2] = atsBTimes[1] + 5
atsBTimes[3] = atsBTimes[2] + 10
atsBTimes[4] = atsBTimes[3] + 60
atsBTimes[5] = atsBTimes[4] + 10
atsBTimes[6] = atsBTimes[5] + 10

;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsb_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_18
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsb_load" B {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsb_load","cpu1_ats_b_load")
...
start load_table ("cpu1_ats_b_load", hostCPU)
...
cmdCtr = SCX_CPU1_TBL_CMDPC + 2

/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=ATSATblName
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=ATSBTblName
...
;; Wait for the validation message
;; If the message is rcv'd, then validation passed
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 2
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS Table Validations were successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
...
;; Wait for the SC validation message
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 2
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - SC ATS validation event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
else
  write "<!> Failed - SC ATS validation event Msg ",SC_VERIFY_ATS_EID, " not rcv'd."
...
/SCX_CPU1_TBL_ACTIVATE ATableName=ATSATblName
/SCX_CPU1_TBL_ACTIVATE ATableName=ATSBTblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 2
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2000.2;2000.3) - ATS Tables Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20002, "P"
  ut_setrequirements SC_20003, "P"
else
...
ut_tlmupdate SCX_CPU1_TBL_CMDPC

;; Check the Free Byte count for both tables
local atsAFreeBytes = freeByteCount - 48
local atsBFreeBytes = freeByteCount - 96
if (SCX_CPU1_SC_FreeBytes[1] = atsAFreeBytes) AND ;;
   (SCX_CPU1_SC_FreeBytes[2] = atsBFreeBytes) then
  write "<*> Passed (2000) - Both ATS tables report the proper free bytes."
  ut_setrequirements SC_2000, "P"
elseif (SCX_CPU1_SC_FreeBytes[1] <> atsAFreeBytes) then
  write "<!> Failed (2000) - ATS A does not report the proper bytes free. got ",SCX_CPU1_SC_FREEBYTES[1], "; Expected ",atsAFreeBytes
  ut_setrequirements SC_2000, "F"
elseif (SCX_CPU1_SC_FreeBytes[2] <> atsBFreeBytes) then
  write "<!> Failed (2000) - ATS B does not report the proper bytes free. got ",SCX_CPU1_SC_FREEBYTES[2], "; Expected ",atsBFreeBytes
  ut_setrequirements SC_2000, "F"
endif

;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl2_12",hostCPU,atsPktId)
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTATS_CMD_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_ERR_SKP_DBG_EID, "DEBUG", 2
...
lastCmdMET = SCX_CPU1_SC_NEXTATSTIME
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_SWITCH_ATS_CMD_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{SCAppName},SC_ATS_ERR_SKP_DBG_EID, "DEBUG", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_ATS_SERVICE_SWTCH_INF_EID, "INFO", 3
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_SWITCH_ATS_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
s get_tbl_to_cvt (ramDir,ATSBCmdTblName,"A","cpu1_atsb_cmd2_15",hostCPU,atsCmdPktId)

;; Command #1 should not indicate "Skipped"
if (p@SCX_CPU1_SC_ATSCMDStatus[1] <> "Skipped") then
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSBTblName,"A","cpu1_atsb_tbl2_15",hostCPU,atsPktId)
...
waitTime = SCX_CPU1_SC_NEXTATSTIME - currentMET
if (waitTime > 0) then
  wait waitTime
endif
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_JUMP_ATS_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{SCAppName},SC_JUMP_ATS_SKIPPED_DBG_EID, "DEBUG", 2
...
cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_JumpATS newTime=jumpTime
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;3003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_JUMP_ATS_INF_EID,"."
  ut_setrequirements SC_1004, "F"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (3003.2.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_JUMP_ATS_SKIPPED_DBG_EID,"."
  ut_setrequirements SC_300321, "F"
endif

;; Need to dump the ATS command table to view each command's status
s get_tbl_to_cvt (ramDir,ATSBCmdTblName,"A","cpu1_atsb_cmd2_16",hostCPU,atsCmdPktId)

;; At least Command #3 should indicate "Skipped"
if (p@SCX_CPU1_SC_ATSCMDStatus[3] = "Skipped") then
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STOPATS_CMD_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STOPATS_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
  write "<!> Failed (2001) - ATS Table validations failed. Expected Event Msg ",CFE_TBL_VALIDATION_INF_EID, " not rcv'd."
  ut_setrequirements SC_2001, "F"
...
;; Check the Free Byte count for ATS A
if (SCX_CPU1_SC_FreeBytes[1] = atsAFreeBytes) then
...
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl2_20",hostCPU,atsPktId)
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_append.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_27
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_append" A {currentMET}

s scx_cpu1_load_ats_append("scx_cpu1_atsa_append","cpu1_ats_a_append")
...
start load_table ("cpu1_ats_a_append", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=ATSAppendTblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2009) - ATS Append Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
...
/SCX_CPU1_TBL_ACTIVATE ATableName=ATSAppendTblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - ATS Append Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "==> AppendCount (after) = ",SCX_CPU1_SC_AppendCount
write "==> AppendSize  (after) = ",SCX_CPU1_SC_AppendSize
write "==> AppendLoads (after) = ",SCX_CPU1_SC_AppendLoads
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_APPEND_CMD_INF_EID, "INFO", 1

local originalLastByte = freeByteCount - SCX_CPU1_SC_FreeBytes[1]

cmdCtr = SCX_CPU1_SC_CMDPC + 1

/SCX_CPU1_SC_AppendATS ATSID=1
...
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2008.6) - Event Msg ",SCX_CPU1_find_event[1].eventid," rcv'd."
  ut_setrequirements SC_20086, "P"
else
  write "<!> Failed - Apply ATS Append Table command. Event Msg ",SCX_CPU1_find_event[1].eventid," rcv'd; Expected ",SC_APPEND_CMD_INF_EID
  ut_setrequirements SC_20086, "F"
endif

;; Check the HK items
if (p@SCX_CPU1_SC_AppendAtsID = "ATS A") then
  write "<*> Passed - Append ATS ID indicates 'A'."
else
  write "<!> Failed - Append ATS ID indicates '",p@SCX_CPU1_SC_AppendAtsID,"'. Expected 'ATS A'."
endif
...
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_NOOP_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", "CFE_SB", CFE_SB_CMD0_RCVD_EID, "INFO", 3
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_COMPL_INF_EID, "INFO", 4
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_ERR_SKP_DBG_EID, "DEBUG", 5
...
;; Check for the event message indicating the number of 
;; commands skipped when the ATS was started
ut_tlmwait SCX_CPU1_find_event[5].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3000.1) - Expected Event Msg ",SC_ATS_ERR_SKP_DBG_EID," rcv'd."
  ut_setrequirements SC_30001, "P"
else
...
s get_tbl_to_cvt (ramDir,ATSAppendTblName,"A","cpu1_append_tbl2_26",hostCPU,appendPktId)

;; Dump the ATS A table
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl2_26",hostCPU,atsPktId)
...
local wordCnt = SCX_CPU1_SC_AppendSize
local dataGood = TRUE
...
for i = 1 to wordCnt do
  write "==> ATS    = ",%hex(SCX_CPU1_SC_ATSDATA[ATSStartWord+i],4)
  write "==> Append = ",%hex(SCX_CPU1_SC_ATSAppendData[i],4)
  if (SCX_CPU1_SC_ATSDATA[ATSStartWord+i] <> SCX_CPU1_SC_ATSAppendData[i]) then
    dataGood = FALSE
    break
  endif
enddo
...
;; Wait for the ATS Completion event message
ut_tlmwait SCX_CPU1_find_event[4].num_found_messages, 1, 200
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
...
step2_27:
write "; SC 2.5.1 requires 4-byte aligned commands. Thus, an odd-byte command"
write "; will not be accepted. Skipping this test. "
goto step3_0
...
;;filename = work & "/image/cpu1_ats_oddbyteld"
;;if NOT file_exists(filename) then
  s scx_cpu1_sc_atsoddbyte
  wait 5
;;endif
...
start load_table ("cpu1_ats_oddbyteld", hostCPU)
...
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_COMPL_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_NOOP_INF_EID, "INFO", 3
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_ERR_SKP_DBG_EID, "DEBUG", 4
...
;; Check for the event message indicating the number of 
;; commands skipped when the ATS was started
ut_tlmwait SCX_CPU1_find_event[4].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3000.1) - Expected Event Msg ",SC_ATS_ERR_SKP_DBG_EID," rcv'd."
  ut_setrequirements SC_30001, "P"
else
...
write ";***********************************************************************"
;; Dump the ATS A table
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl2_31",hostCPU,atsPktId)
wait 5

;; Wait the the ATS Completion event message
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1, 200
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - ATS A completed execution."
else
  write "<!> Failed - Did not rcv the ATS Completion message."
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_LEN_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1
rawcmd = ""
  
;; CPU1 is the default
rawcmd = "18A9c000000402B0"

ut_sendrawcmd "SCX_CPU1_SC", (rawcmd)

ut_tlmwait SCX_CPU1_SC_CMDEC, {errcnt}
if (UT_TW_Status = UT_Success) then
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",SC_LEN_ERR_EID, "."
  ut_setrequirements SC_1005, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_STARTATS_CMD_INVLD_ID_ERR_EID,"ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_StartATS ATSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTATS_CMD_INVLD_ID_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_JUMPATS_CMD_NOT_ACT_ERR_EID,"ERROR",1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_JUMPATS_CMD_NOT_ACT_ERR_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_APPEND_CMD_ARG_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_AppendATS ATSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_APPEND_CMD_ARG_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_load3.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step4_5
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_load3" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load3","cpu1_ats_a_load3",0)

;; Set the locations in the ATS Data with the invalid checksum values
SCX_CPU1_SC_ATSDATA[14] = x'0002'
SCX_CPU1_SC_ATSDATA[28] = x'0002'

;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Table Load", "cpu1_ats_a_load3",ATSATblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[42]")
...
start load_table ("cpu1_ats_a_load3", hostCPU)
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSATblName,"I","cpu1_atsa_tbl4_2",hostCPU,atsPktId)
...
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_DUP_ERR_EID, "ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS A Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
...
if (SCX_CPU1_find_event[3].num_found_messages = 1) then
  write "<*> Passed - Duplicate command number detected in ATS load file. Event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
else
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=ATSATblName
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_SWITCH_ATS_CMD_IDLE_ERR_EID,"ERROR",1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_SWITCH_ATS_CMD_IDLE_ERR_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
filename = work & "/image/cpu1_ats_maxcmd_ld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_maxcmdats
  wait 5
endif
...
start load_table ("cpu1_ats_maxcmd_ld", hostCPU)
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_NUM_ERR_EID, "ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2000.2) - ATS A Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20002, "P"
else
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSATblName,"I","cpu1_atsa_tbl4_9",hostCPU,atsPktId)
...
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_load4.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step4_19
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_load4" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load4","cpu1_ats_a_load4",0)

;; Set the location in the ATS Data with an invalid checksum value
SCX_CPU1_SC_ATSDATA[32] = x'0080'

;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Table Load", "cpu1_ats_a_load4",ATSATblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[42]")
...
start load_table ("cpu1_ats_a_load4", hostCPU)
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS A Table Validation successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
  write "<!> Failed (2001) - ATS A Table validation failed. Expected Event Msg ",CFE_TBL_VALIDATION_INF_EID," not rcv'd."
  ut_setrequirements SC_2001, "F"
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl4_14",hostCPU,atsPktId)
...
write ";***********************************************************************"
;; Need to dump the ATS command table to view each command's status
s get_tbl_to_cvt (ramDir,ATSACmdTblName,"A","cpu1_atsa_cmd4_17",hostCPU,atsCmdPktId)

;; Commands #1-3 should indicate "Skipped"
if (p@SCX_CPU1_SC_ATSCMDStatus[1] = "Skipped") AND ;;
   (p@SCX_CPU1_SC_ATSCMDStatus[2] = "Skipped") AND ;;
   (p@SCX_CPU1_SC_ATSCMDStatus[3] = "Skipped") then
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_ABT_ERR_EID, "ERROR", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ATS_CHKSUM_ERR_EID, "ERROR", 2
...
s get_tbl_to_cvt (ramDir,ATSACmdTblName,"A","cpu1_atsa_cmd4_18",hostCPU,atsCmdPktId)

;; Command #4 should indicate "Failed Checksum"
if (p@SCX_CPU1_SC_ATSCMDStatus[4] = "Failed Checksum") then
...
if (SCX_CPU1_SC_LastATSCmdErr = 4) then
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_COMPL_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_ES_CMDPC + 2

/SCX_CPU1_ES_RESTARTAPP Application=SCAppName
/SCX_CPU1_ES_RESTARTAPP Application="TST_SC"
wait 5
...
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_load5.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step4_29
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_load5" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load5","cpu1_ats_a_load5",0)

;; Set the data words to cause an invalid checksum for cmd #3
SCX_CPU1_SC_ATSDATA[24] = x'0068'

;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Table Load", "cpu1_ats_a_load5",ATSATblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[50]")
wait 1
...
start load_table ("cpu1_ats_a_load5", hostCPU)
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSATblName,"A","cpu1_atsa_tbl4_23",hostCPU,atsPktId)
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_ATS_CHKSUM_ERR_EID, "ERROR", 1
ut_setupevents "SCX","CPU1",{SCAppName},SC_ATS_INLINE_SWTCH_NOT_LDED_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_JUMPATS_CMD_STOPPED_ERR_EID,"ERROR",3

lastCmdMET = SCX_CPU1_SC_NEXTATSTIME + 15
switchCmdTime = SCX_CPU1_SC_NEXTATSTIME + 30
...
if (p@SCX_CPU1_SC_ATPState = "Executing") then
...
;; Need to dump the ATS command table to view command #4's status
s get_tbl_to_cvt (ramDir,ATSACmdTblName,"A","cpu1_atsa_cmd4_26",hostCPU,atsCmdPktId)

;; Command #3 should indicate "Failed Checksum"
if (p@SCX_CPU1_SC_ATSCMDStatus[3] = "Failed Checksum") then
...
write "-- NextATSCmd MET=> ",SCX_CPU1_SC_NEXTATSTIME
write "-- CURRENT MET => ", currentMET, " (hex) = ", %hex(currentMET,8)
...
s scx_cpu1_load_ats_rts("scx_cpu1_atsb_load","cpu1_ats_b_load2")
...
start load_table ("cpu1_ats_b_load2", hostCPU)
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - ATS B Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
...
if (SCX_CPU1_find_event[2].num_found_messages = 1) then
  write "<*> Passed (2000.2;2000.3) - ATS B Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20002, "P"
  ut_setrequirements SC_20003, "P"
else
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSBTblName,"A","cpu1_atsb_tbl4_32",hostCPU,atsPktId)
...
atsBTimes[1] = SCX_CPU1_SC_NEXTATSTIME
atsBTimes[2] = atsBTimes[1] + 5
atsBTimes[3] = atsBTimes[1] + 15
atsBTimes[4] = atsBTimes[1] + 75
atsBTimes[5] = atsBTimes[1] + 85
atsBTimes[6] = atsBTimes[1] + 85
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_JUMP_ATS_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
if (SCX_CPU1_SC_ATPCmdNumber = 4) then
...
if (SCX_CPU1_SC_ATPCmdNumber = 5) then
  write "<*> Passed (3003.4) - Housekeeping indicates that Command #5 is next to execute."
  ut_setrequirements SC_30034, "P"
else
  write "<!> Failed (3003.4) - The next expected command is not correct. Expected 5; Next Cmd = ",SCX_CPU1_SC_ATPCmdNumber
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_STARTATS_CMD_NOT_IDLE_ERR_EID,"ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTATS_CMD_INF_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_MPT_ERR_EID, "ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (3000) - ATS A Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_3000, "P"
else
...
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - ATS A Table Table empty event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
else
...
write ";***********************************************************************"
;; Check if the load file exists before creating it
filename = work & "/image/cpu1_cmdoffend_ld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_atsoffend
  wait 5
endif
...
start load_table ("cpu1_cmdoffend_ld", hostCPU)
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_BUF_ERR_EID, "ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - SC ATS Validation event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
...
SCX_CPU1_SC_ATSDATA[1] = 0
SCX_CPU1_SC_ATSDATA[2] = 1
;; The next 2 values are the absolute time-tag
SCX_CPU1_SC_ATSDATA[3] = highWord
SCX_CPU1_SC_ATSDATA[4] = lowWord + 100
SCX_CPU1_SC_ATSDATA[5] = x'1B37'
SCX_CPU1_SC_ATSDATA[6] = x'C000'
SCX_CPU1_SC_ATSDATA[7] = SC_PACKET_MAX_SIZE + 2
SCX_CPU1_SC_ATSDATA[8] = x'03EE'
SCX_CPU1_SC_ATSDATA[9] = x'0000'
SCX_CPU1_SC_ATSDATA[10] = x'0007'
SCX_CPU1_SC_ATSDATA[11] = x'18A9'
SCX_CPU1_SC_ATSDATA[12] = x'C000'
SCX_CPU1_SC_ATSDATA[13] = x'0001'
SCX_CPU1_SC_ATSDATA[14] = x'008D'
...
for i = 15 to SC_ATS_BUFF_SIZE DO
  SCX_CPU1_SC_ATSDATA[i] = 0
enddo
...
;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Time Table Load", "cpu1_ats_a_load6",ATSATblName, "SCX_CPU1_SC_ATSDATA[1]", "SCX_CPU1_SC_ATSDATA[192]")
...
start load_table ("cpu1_ats_a_load6", hostCPU)
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VAL_REQ_MADE_INF_EID, "DEBUG", 1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_VALIDATION_ERR_EID, "ERROR", 2
ut_setupevents "SCX","CPU1",{SCAppName},SC_VERIFY_ATS_PKT_ERR_EID, "ERROR", 3
...
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2001) - Invalid Packet Length error Event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
  ut_setrequirements SC_2001, "P"
else
...
;; 1st command => TST_SC_GetCRC with a length > SC_PACKET_MAX_SIZE
SCX_CPU1_SC_ATSAPPENDDATA[1] = 0
SCX_CPU1_SC_ATSAPPENDDATA[2] = 1
;; The next 2 values are the absolute time-tag
SCX_CPU1_SC_ATSAPPENDDATA[3] = highWord
SCX_CPU1_SC_ATSAPPENDDATA[4] = lowWord + 100
SCX_CPU1_SC_ATSAPPENDDATA[5] = x'1B37'
SCX_CPU1_SC_ATSAPPENDDATA[6] = x'C000'
SCX_CPU1_SC_ATSAPPENDDATA[7] = SC_PACKET_MAX_SIZE + 2
SCX_CPU1_SC_ATSAPPENDDATA[8] = x'03EE'
SCX_CPU1_SC_ATSAPPENDDATA[9] = x'0000'
SCX_CPU1_SC_ATSAPPENDDATA[10] = x'0007'
SCX_CPU1_SC_ATSAPPENDDATA[11] = x'18A9'
SCX_CPU1_SC_ATSAPPENDDATA[12] = x'C000'
SCX_CPU1_SC_ATSAPPENDDATA[13] = x'0001'
SCX_CPU1_SC_ATSAPPENDDATA[14] = x'008D'
...
;; Zero out the rest of the table buffer
for i = 15 to SC_APPEND_BUFF_SIZE DO
...
;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS Append Cmd To Big Error","cpu1_append_load3",ATSAppendTblName,"SCX_CPU1_SC_ATSAPPENDDATA[1]",endmnemonic)
...
start load_table ("cpu1_append_load3", hostCPU)
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - ATS Append Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=ATSAppendTblName
...
write ";***********************************************************************"
;; Check if the load file exists before creating it
filename = work & "/image/cpu1_appoffend_ld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_appoffend
  wait 5
endif
...
start load_table ("cpu1_appoffend_ld", hostCPU)
...
write ";***********************************************************************"
;; Check if the load file exists before creating it
filename = work & "/image/cpu1_ats_700cmd_ld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_700cmdats
  wait 5
endif
...
start load_table ("cpu1_ats_700cmd_ld", hostCPU)
...
;; Need to dump the ATS table
s get_tbl_to_cvt (ramDir,ATSBTblName,"A","cpu1_atsb_tbl4_58",hostCPU,atsPktId)
...
write ";***********************************************************************"
;; Check if the load file exists before creating it
filename = work & "/image/cpu1_appfull_ld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_appendfull
  wait 5
endif
...
start load_table ("cpu1_appfull_ld", hostCPU)
...
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_LOAD_PEND_REQ_INF_EID,"DEBUG",1
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",2
ut_setupevents "SCX","CPU1",{SCAppName},SC_UPDATE_APPEND_EID,"INFO",3
...
ut_tlmwait SCX_CPU1_find_event[3].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2009) - ATS Append Table Updated successfully. Event Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
  ut_setrequirements SC_2009, "P"
else
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_APPEND_CMD_FIT_ERR_EID,"ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

/SCX_CPU1_SC_AppendATS ATSID=2
...
ut_tlmwait SCX_CPU1_find_event[1].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (1005) - Event Msg ",SCX_CPU1_find_event[1].eventid," rcv'd."
  ut_setrequirements SC_1005, "P"
else
  write "<!> Failed (1005) - Apply ATS Append Table command. Event Msg ",SCX_CPU1_find_event[1].eventid," rcv'd; Expected ",SC_APPEND_CMD_FIT_ERR_EID
  ut_setrequirements SC_1005, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_APPEND_CMD_TGT_ERR_EID, "ERROR", 1
...
write ";  command should fail because ATS A is empty. "
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_APPEND_CMD_SRC_ERR_EID, "ERROR", 1
...
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_atsa_load7.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step6_0
endif
...
;; Using the SCP utilities, compile and build the ATS load file
compile_ats "scx_cpu1_atsa_load7" A {currentMET}

s scx_cpu1_load_ats_rts("scx_cpu1_atsa_load7","cpu1_ats_a_load7")
...
start load_table ("cpu1_ats_a_load7", hostCPU)
...
write ";*********************************************************************"
local leapSeconds = SCX_CPU1_TIME_LEAPSECS - 5

;; Send the command to set the leap seconds
/SCX_CPU1_TIME_SetClockLeap Leaps=leapSeconds
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_sc_atsfunc"
write ";*********************************************************************"
ENDPROC
