...
local endmnemonic = "SCX_CPU1_SC_ATSDATA[" & i & "]"

;; Create the ATS Table Load file
s create_tbl_file_from_cvt (hostCPU,atsPktId,"ATS A Table 700 Commands Load","cpu1_ats_700cmd_ld",ATSBTblName,"SCX_CPU1_SC_ATSDATA[1]",endmnemonic)
wait 5

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_sc_700cmdsats"
write ";*********************************************************************"
ENDPROC
