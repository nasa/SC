...
;; SC_NOOP Command = '0000 0000 1xA9 C000 0001 00yy'
...
for i = 1 to SC_RTS_BUFF_SIZE - 10  do
  ...
  elseif (j = 2) then
    SCX_CPU1_SC_RTSDATA[i] = 5
  elseif (j = 3) then
    SCX_CPU1_SC_RTSDATA[i] = nextCmd
  elseif (j = 4) then
    SCX_CPU1_SC_RTSDATA[i] = x'C000'
  elseif (j = 5) then
    SCX_CPU1_SC_RTSDATA[i] = x'0001'
  elseif (j = 6) then
    SCX_CPU1_SC_RTSDATA[i] = nextCRC
  endif
  j = j + 1
  if (j = 7) then
    j = 1
...
SCX_CPU1_SC_RTSDATA[i] = 5
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'192B'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'C000'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'0027'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'0365'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'5343'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'2E41'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'5453'
i = i + 1
SCX_CPU1_SC_RTSDATA[i] = x'5F54'
...
s create_tbl_file_from_cvt (hostCPU,rtsPktId,"RTS 15 Table Command off end Load", "cpu1_rts015_load",RTSTbl15Name,"SCX_CPU1_SC_RTSDATA[1]",endmnemonic)
wait 5

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_sc_rtsoffend"
write ";*********************************************************************"
ENDPROC
