...
page SCX_CPU1_SC_RTS_TBL
page SCX_CPU1_TBL_REGISTRY
...
s get_file_to_cvt (ramDir, "cfe_tbl_reg.log", "scx_cpu1_tbl_reg.log", hostCPU)
wait 10
...
for i = 1 to SCX_CPU1_TBL_NUMTABLES do
  rtsTable = %substring(SCX_CPU1_RF[i].SCX_CPU1_TBL_Name,1,rtsPrefixLen)
...
s get_tbl_to_cvt (ramDir,RTS2TblName,"A","cpu1_rts2_tbl2_4",hostCPU,rtsPktId)
...
for i = 1 to SC_RTS_BUFF_SIZE do
  write "RTSData[",i,"] = ",SCX_CPU1_SC_RTSDATA[i]
enddo
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ENABLE_RTS_DEB_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_EnableRTS RTSID=2
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ENABLE_RTS_DEB_EID,"."
  ut_setrequirements SC_1004, "F"
endif

;; Make sure that the status indicates Enabled
write "--RTS Disable Status for 16->1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS2Status
...
local filename = work & "/image/scx_cpu1_rts2_load.scs"
...
s scx_cpu1_load_ats_rts("scx_cpu1_rts2_load","cpu1_rts002_load")
...
start load_table ("cpu1_rts002_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS2TblName
...
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #2 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS2TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #2 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 1-16 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS2Status
write "--Bit 2 value = ",disableStatus
...
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_COMPL_INF_EID, "INFO", 2
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_RTS_START_INF_EID,"."
  ut_setrequirements SC_1004, "F"
  ut_setrequirements SC_40001, "F"
endif
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (4001.4) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_RTS_COMPL_INF_EID,"."
...
/SCX_CPU1_TST_SC_GetCRC DataSize=7 dataArray=testData
wait 10
write "Command Checksum for 7 bytes of data = ",SCX_CPU1_TST_SC_CmdCRC

/SCX_CPU1_TST_SC_GetCRC DataSize=8 dataArray=testData
wait 10
write "Command Checksum for 8 bytes of data = ",SCX_CPU1_TST_SC_CmdCRC
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts3_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_21
endif
...
;; Using the SCP utilities, compile and build the RTS 3 load file
compile_rts "scx_cpu1_rts3_load" 3
s scx_cpu1_load_ats_rts("scx_cpu1_rts3_load","cpu1_rts003_load")
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts8_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_21
endif
...
;; Using the SCP utilities, compile and build the RTS 3 load file
compile_rts "scx_cpu1_rts8_load" 8
s scx_cpu1_load_ats_rts("scx_cpu1_rts8_load","cpu1_rts008_load")
...
start load_table ("cpu1_rts003_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS3TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #3 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS3TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #3 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16-1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS3Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS3TblName,"A","cpu1_rts3_tbl2_12",hostCPU,rtsPktId)
...
start load_table ("cpu1_rts008_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS8TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #8 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS8TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #8 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16-1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS8Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS8TblName,"A","cpu1_rts8_tbl2_16",hostCPU,rtsPktId)
...
cmdCtr = SCX_CPU1_SC_CMDPC + 2
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=3
/SCX_CPU1_SC_StartRTS RTSID=8
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_DISABLE_RTS_DEB_EID, "DEBUG", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_COMPL_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_DisableRTS RTSID=3
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_DISABLE_RTS_DEB_EID,"."
  ut_setrequirements SC_1004, "F"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004;4005) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_RTS_COMPL_INF_EID,"."
  ut_setrequirements SC_1004, "F"
  ut_setrequirements SC_4005, "F"
endif
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts5_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_27
endif
...
;; Using the SCP utilities, compile and build the RTS 3 load file
compile_rts "scx_cpu1_rts5_load" 5
s scx_cpu1_load_ats_rts("scx_cpu1_rts5_load","cpu1_rts005_load")
...
start load_table ("cpu1_rts005_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS5TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #5 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS5TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #5 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 1-16 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS5Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS5TblName,"A","cpu1_rts5_tbl2_23",hostCPU,rtsPktId)
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STOPRTS_CMD_INF_EID, "INFO", 2

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=5
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts4_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step2_35
endif
...
compile_rts "scx_cpu1_rts4_load" 4
s scx_cpu1_load_ats_rts("scx_cpu1_rts4_load","cpu1_rts004_load")
...
start load_table ("cpu1_rts004_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS4TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #4 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS4TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #4 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16-1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS4Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS4TblName,"A","cpu1_rts4_tbl2_29",hostCPU,rtsPktId)
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", "CFE_TIME", CFE_TIME_NOOP_EID, "INFO", 2

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=4
...
write ";  encountered."
write ";***********************************************************************"
if (SCX_CPU1_find_event[2].num_found_messages = 3) then
  write "<*> Passed (4002) - RTS #4 stopped when null data was encountered."
  ut_setrequirements SC_4002, "P"
else
  write "<!> Failed (4002) - RTS #4 stopped prematurely. Expected 3 event msgs and rcv'd ",SCX_CPU1_find_event[2].num_found_messages
  ut_setrequirements SC_4002, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STOPRTS_CMD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_StopRTS RTSID=4
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STOPRTS_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts7_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step3_0
endif
...
compile_rts "scx_cpu1_rts7_load" 7
s scx_cpu1_load_ats_rts("scx_cpu1_rts7_load","cpu1_rts007_load")
...
start load_table ("cpu1_rts007_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS7TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #7 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS7TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #7 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16-1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS7Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS7TblName,"A","cpu1_rts7_tbl2_37",hostCPU,rtsPktId)
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (4000.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_RTS_COMPL_INF_EID,"."
  ut_setrequirements SC_40001, "F"
endif
...
write ";  Step 2.41 thru 2.45 are skipped sinceodd-byte commands will not work with cFE6.8"
goto step2_46
...
filename = work & "/image/cpu1_rts3oddbyteld"
if NOT file_exists(filename) then
  s scx_cpu1_sc_rtsoddbyte
  wait 5
endif
...
start load_table ("cpu1_rts3oddbyteld", hostCPU)
...
write "--RTS Disable Status for 16->1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
if (SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus <> x'FF20') then
  ;; Send the Enable Group command for RTSs 2 through #5
  /SCX_CPU1_SC_EnableRTSGroup FirstRTSID=2 LastRTSID=5
  wait 5
endif
...
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_DISRTSGRP_CMD_INF_EID, "INFO", 1

;; Send the Disable RTS Group Command
cmdCtr = SCX_CPU1_SC_CMDPC

/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=2 LastRTSID=5
wait 5

if (SCX_CPU1_SC_CMDPC > cmdCtr) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_DISRTSGRP_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ENARTSGRP_CMD_INF_EID, "INFO", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ENARTSGRP_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTRTSGRP_CMD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_SC_CMDPC

/SCX_CPU1_SC_StartRTSGroup FirstRTSID=2 LastRTSID=5
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTSGRP_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STOPRTSGRP_CMD_INF_EID, "INFO", 1

cmdCtr = SCX_CPU1_SC_CMDPC

/SCX_CPU1_SC_StopRTSGroup FirstRTSID=2 LastRTSID=5
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STOPRTSGRP_CMD_INF_EID,"."
  ut_setrequirements SC_1004, "F"
endif
...
local errcnt = SCX_CPU1_SC_CMDEC + 1
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  write "<*> Passed (1002;1005) - Event message ",SCX_CPU1_find_event[1].eventid, " received"
  ut_setrequirements SC_1002, "P"
  ut_setrequirements SC_1005, "P"
else
  write "<!> Failed (1002;1005) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",SC_LEN_ERR_EID, "."
  ut_setrequirements SC_1002, "F"
  ut_setrequirements SC_1005, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTRTS_CMD_INVALID_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTS_CMD_INVALID_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STOPRTS_CMD_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_StopRTS RTSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STOPRTS_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_StopRTS RTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ENARTS_CMD_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_EnableRTS RTSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ENARTS_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_EnableRTS RTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_DISRTS_CMD_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_DisableRTS RTSID=0
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_DISRTS_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_DisableRTS RTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_STARTRTSGRP_CMD_ERR_EID,"ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_StartRTSGroup FirstRTSID=0 LastRTSID=5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTSGRP_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_StartRTSGroup FirstRTSID=8 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_StartRTSGroup FirstRTSID=SC_NUMBER_OF_RTS+1 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_StartRTSGroup FirstRTSID=2 LastRTSID=0
...
;; Send the Command
/SCX_CPU1_SC_StartRTSGroup FirstRTSID=2 LastRTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_STOPRTSGRP_CMD_ERR_EID,"ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_StopRTSGroup FirstRTSID=0 LastRTSID=5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STOPRTSGRP_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_StopRTSGroup FirstRTSID=8 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_StopRTSGroup FirstRTSID=SC_NUMBER_OF_RTS+1 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_StopRTSGroup FirstRTSID=2 LastRTSID=0
...
;; Send the Command
/SCX_CPU1_SC_StopRTSGroup FirstRTSID=2 LastRTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_ENARTSGRP_CMD_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_EnableRTSGroup FirstRTSID=0 LastRTSID=5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_ENARTSGRP_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_EnableRTSGroup FirstRTSID=8 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_EnableRTSGroup FirstRTSID=SC_NUMBER_OF_RTS+1 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_EnableRTSGroup FirstRTSID=2 LastRTSID=0
...
;; Send the Command
/SCX_CPU1_SC_EnableRTSGroup FirstRTSID=2 LastRTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_DISRTSGRP_CMD_ERR_EID, "ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1

;; Send the Command
/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=0 LastRTSID=5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1004) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_DISRTSGRP_CMD_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
endif
...
;; Send the Command
/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=7 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=SC_NUMBER_OF_RTS+1 LastRTSID=5
...
;; Send the Command
/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=2 LastRTSID=0
...
;; Send the Command
/SCX_CPU1_SC_DisableRTSGroup FirstRTSID=2 LastRTSID=SC_NUMBER_OF_RTS+1
...
write ";***********************************************************************"
;; Create the command
SCX_CPU1_SC_RTSDATA[1] = 5
SCX_CPU1_SC_RTSDATA[2] = x'1B37'
SCX_CPU1_SC_RTSDATA[3] = x'C000'
;;SCX_CPU1_SC_RTSDATA[4] = x'0105'
SCX_CPU1_SC_RTSDATA[4] = SC_PACKET_MAX_SIZE + 2
SCX_CPU1_SC_RTSDATA[5] = x'03EE'
SCX_CPU1_SC_RTSDATA[6] = x'0000'
SCX_CPU1_SC_RTSDATA[7] = x'0007'
SCX_CPU1_SC_RTSDATA[8] = x'18A9'
SCX_CPU1_SC_RTSDATA[9] = x'C000'
SCX_CPU1_SC_RTSDATA[10] = x'0001'
SCX_CPU1_SC_RTSDATA[11] = x'008D'

;; zero out the rest of the table buffer
for i = 12 to SC_RTS_BUFF_SIZE DO
  SCX_CPU1_SC_RTSDATA[i] = x'0000'
enddo

local endmnemonic = "SCX_CPU1_SC_RTSDATA[" & SC_RTS_BUFF_SIZE & "]"

;; Create the RTS Table Load file
s create_tbl_file_from_cvt (hostCPU,rtsPktId,"RTS #6 Table Load","cpu1_rts006_load",RTS6TblName,"SCX_CPU1_SC_RTSDATA[1]",endmnemonic)
...
start load_table ("cpu1_rts006_load", hostCPU)
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS6TblName,"I","cpu1_rts6_tbl4_1",hostCPU,rtsPktId)
...
ut_setupevents "SCX","CPU1",{SCAppName},SC_RTS_LEN_ERR_EID, "ERROR", 3

cmdCtr = SCX_CPU1_TBL_CMDPC + 1

/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS6TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.3) - RTS #6 Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20023, "P"
else
...
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.3) - RTS #6 Invalid command length Msg ",SCX_CPU1_find_event[3].eventid," rcv'd."
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_LOADABORT ABTABLENAME=RTS6TblName
...
write ";***********************************************************************"
;; Need to check if the .scs file used below exists. If not, end the proc
filename = work & "/image/scx_cpu1_rts9_load.scs"
if NOT file_exists(filename) then
  write "<!> Failed - Expected load file '",filename, "' not found. Skipping this test."
  goto step4_9
endif
...
compile_rts "scx_cpu1_rts9_load" 9
s scx_cpu1_load_ats_rts("scx_cpu1_rts9_load","cpu1_rts009_load",0,1)

;; Setup the invalid Data Integrity checks
SCX_CPU1_SC_RTSDATA[15] = x'0026'
SCX_CPU1_SC_RTSDATA[20] = x'0120'

;; Create the RTS Table Load file
s create_tbl_file_from_cvt (hostCPU,rtsPktId,"RTS #9 Table Load","cpu1_rts009_load",RTS9TblName,"SCX_CPU1_SC_RTSDATA[1]",endmnemonic)
...
start load_table ("cpu1_rts009_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS9TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #9 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS9TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #9 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16-1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS9Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS9TblName,"A","cpu1_rts9_tbl4_5",hostCPU,rtsPktId)
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_START_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_RTS_CHKSUM_ERR_EID, "ERROR", 2

cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=9
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (4001.3.1) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_RTS_CHKSUM_ERR_EID,"."
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTRTS_CMD_NOT_LDED_ERR_EID, "ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005;4000.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTS_CMD_NOT_LDED_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
  ut_setrequirements SC_40002, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {SCAppName}, SC_STARTRTS_CMD_DISABLED_ERR_EID, "ERROR", 1
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005;4000.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTS_CMD_DISABLED_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
  ut_setrequirements SC_40002, "F"
endif
...
cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_EnableRTS RTSID=11
...
;; Make sure that the status indicates Enabled
write "--RTS Disable Status for 16->1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS11Status
...
;; Clear out the RDL
for i = 1 to SC_RTS_BUFF_SIZE DO
  SCX_CPU1_SC_RTSDATA[i] = 0
enddo

;; Create the RTS Table Load file
s create_tbl_file_from_cvt (hostCPU,rtsPktId,"RTS #10 Table Load", "cpu1_rts010_load",RTS10TblName, "SCX_CPU1_SC_RTSDATA[1]",endmnemonic)
...
start load_table ("cpu1_rts010_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS10TblName
...
ut_tlmwait  SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #10 Table Validation was successful. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
/SCX_CPU1_TBL_ACTIVATE ATableName=RTS10TblName
...
ut_tlmwait  SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - RTS #10 Table Updated successfully. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
else
...
write "--RTS Disable Status for 16->1 = ", %bin(SCX_CPU1_SC_RTSDisableStatus[1].RTSStatusEntry.AllStatus,16)
disableStatus = SCX_CPU1_SC_RTSDISABLESTATUS[1].RTSStatusEntry.RTS10Status
...
;; Need to dump the RTS table
s get_tbl_to_cvt (ramDir,RTS10TblName,"A","cpu1_rts10_tbl4_15",hostCPU,rtsPktId)
...
cmdCtr = SCX_CPU1_SC_CMDPC + 1
;; Send the Command
/SCX_CPU1_SC_EnableRTS RTSID=10
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{SCAppName},SC_STARTRTS_CMD_INVLD_LEN_ERR_EID,"ERROR", 1

errcnt = SCX_CPU1_SC_CMDEC + 1
;; Send the Command
/SCX_CPU1_SC_StartRTS RTSID=10
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1005;4000.2) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",SC_STARTRTS_CMD_INVLD_LEN_ERR_EID,"."
  ut_setrequirements SC_1005, "F"
  ut_setrequirements SC_40002, "F"
endif
...
start load_table ("cpu1_rts015_load", hostCPU)
...
/SCX_CPU1_TBL_VALIDATE INACTIVE VTABLENAME=RTS15TblName
...
ut_tlmwait SCX_CPU1_find_event[2].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2002.2;2002.3) - RTS #15 Table Validation failed as expected. Event Msg ",SCX_CPU1_find_event[2].eventid," rcv'd."
  ut_setrequirements SC_20022, "P"
  ut_setrequirements SC_20023, "P"
else
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_sc_rtsfunc"
write ";*********************************************************************"
ENDPROC
