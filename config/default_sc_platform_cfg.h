 ...
 * @file
 *
 * CFS Stored Command (SC) Application Platform Configuration Header File
 *
 ...
 * dictionary tool.
 */
#ifndef DEFAULT_SC_PLATFORM_CFG_H
#define DEFAULT_SC_PLATFORM_CFG_H

#include "sc_mission_cfg.h"
#include "sc_internal_cfg.h"
