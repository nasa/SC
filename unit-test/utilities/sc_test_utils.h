...
#define SC_Assert_ID_EQ(actual, ref)                          \
    UtAssert_GenericUnsignedCompare(SC_IDNUM_AS_UINT(actual), \
                                    UtAssert_Compare_EQ,      \
                                    SC_IDNUM_AS_UINT(ref),    \
...
#define SC_Assert_IDX_EQ(actual, ref)                       \
    UtAssert_GenericUnsignedCompare(SC_IDX_AS_UINT(actual), \
                                    UtAssert_Compare_EQ,    \
                                    SC_IDX_AS_UINT(ref),    \
                                    UtAssert_Radix_DECIMAL, \
                                    __FILE__,               \
...
#define SC_Assert_CmdStatus(actual, ref)                     \
    UtAssert_GenericUnsignedCompare((unsigned long)(actual), \
                                    UtAssert_Compare_EQ,     \
                                    (unsigned long)(ref),    \
                                    UtAssert_Radix_DECIMAL,  \
                                    __FILE__,                \
