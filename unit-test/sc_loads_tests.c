...
void SC_LoadAts_Test_CmdRunOffEndOfBuffer(void)
{
    ...
    BufEntrySize  = (MsgSize + 3 + SC_ATS_HEADER_SIZE) / SC_BYTES_IN_WORD;
...
void SC_LoadAts_Test_AtsBufferTooSmall(void)
{
    ...
    BufEntrySize  = ((MsgSize1 + 3) / SC_BYTES_IN_WORD) + SC_ATS_HDR_NOPKT_WORDS;
    ...
    j += ((MsgSize2 + 3) / SC_BYTES_IN_WORD) + SC_ATS_HDR_NOPKT_WORDS;
    Entry            = (SC_AtsEntryHeader_t *)&SC_OperData.AtsTblAddr[AtsIndex][j];
    Entry->CmdNumber = i + 1;
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetSize), &MsgSize1, sizeof(MsgSize1), false);
...
void SC_LoadAts_Test_AtsEntryOverflow(void)
{
    ...
    j += ((MsgSize2 + 3) / SC_BYTES_IN_WORD) + SC_ATS_HDR_WORDS;
    Entry            = (SC_AtsEntryHeader_t *)&SC_OperData.AtsTblAddr[AtsIndex][j];
    Entry->CmdNumber = i + 1;
    UT_SetDataBuffer(UT_KEY(CFE_MSG_GetSize), &MsgSize1, sizeof(MsgSize1), false);
...
void SC_LoadAts_Test_LoadExactlyBufferLength(void)
{
    ...
    MsgSize1      = SC_PACKET_MAX_SIZE;
    BufEntrySize  = (MsgSize1 + 3 + SC_ATS_HEADER_SIZE) / SC_BYTES_IN_WORD;
    MaxBufEntries = SC_ATS_BUFF_SIZE32 / BufEntrySize;
...
void SC_LoadAts_Test_InvalidIndex(void)
{
    ...
    snprintf(ExpectedEventString, CFE_MISSION_EVS_MAX_MESSAGE_LENGTH, 
        "ATS load error: invalid ATS index %%d");
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_LOADATS_INV_INDEX_ERR_EID);
...
void SC_BuildTimeIndexTable_Test_InvalidIndex(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_BUILD_TIME_IDXTBL_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_Insert_Test_InvalidIndex(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_INSERTATS_INV_INDEX_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_InitAtsTables_Test_InvalidIndex(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_INIT_ATSTBL_INV_INDEX_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_ValidateAppend_Test(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_ValidateAppend((uint32 *)(SC_OperData.AtsTblAddr[AtsIndex]));
...
void SC_LoadRts_Test_InvalidIndex(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_LOADRTS_INV_INDEX_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_ParseRts_Test_InvalidMsgId(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_RTS_INVLD_MID_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_ParseRts_Test_LengthErrorTooShort(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_RTS_LEN_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_ParseRts_Test_CmdRunsOffEndOfBuffer(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_RTS_LEN_BUFFER_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_ParseRts_Test_CmdLengthEqualsBufferLength(void)
{
    ...
    MsgSize1     = SC_PACKET_MAX_SIZE;
    BufEntrySize = (MsgSize1 + 3 + SC_RTS_HEADER_SIZE) / SC_BYTES_IN_WORD;
...
void SC_ParseRts_Test_CmdDoesNotFitBufferNotEmpty(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_RTS_LEN_TOO_LONG_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_UpdateAppend_Test_Nominal(void)
{
    ...
    SC_AtsEntryHeader_t *Entry;
    uint8                EntryIndex = 0;
    uint32               AtsAppendTable[SC_APPEND_BUFF_SIZE];
    size_t               MsgSize;
    int32                strCmpResult;
    char                 ExpectedEventString[CFE_MISSION_EVS_MAX_MESSAGE_LENGTH];
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_UPDATE_APPEND_EID);
...
void SC_UpdateAppend_Test_CmdDoesNotFitBuffer(void)
{
    ...
    /* Set to reach code block starting with comment "Compute buffer index for next Append ATS table entry" */
    MsgSize       = SC_PACKET_MAX_SIZE;
    BufEntrySize  = (MsgSize + 3) / SC_BYTES_IN_WORD + SC_ATS_HDR_NOPKT_WORDS;
    MaxBufEntries = SC_APPEND_BUFF_SIZE32 / BufEntrySize + 1;
...
void SC_ProcessAppend_Test_InvalidIndex(void)
{
    ...
    /* Verify results */
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_PROCESS_APPEND_INV_INDEX_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsTable_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_VerifyAtsTable((uint32 *)(SC_OperData.AtsTblAddr[AtsIndex]), SC_ATS_BUFF_SIZE);
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_INFORMATION);
...
void SC_VerifyAtsTable_Test_EmptyTable(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_MPT_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsEntry_Test_Nominal(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_VerifyAtsEntry((uint32 *)(SC_OperData.AtsTblAddr[AtsIndex]), AtsIndex, SC_ATS_BUFF_SIZE);

    /* Verify results */
    UtAssert_True(Result == SC_ATS_HDR_NOPKT_WORDS + ((SC_PACKET_MAX_SIZE + 3) / SC_BYTES_IN_WORD),
                  "Result == SC_ATS_HDR_NOPKT_WORDS + (SC_PACKET_MAX_SIZE + 3) / SC_BYTES_IN_WORD");
...
void SC_VerifyAtsEntry_Test_EndOfBuffer(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_VerifyAtsEntry((uint32 *)(SC_OperData.AtsTblAddr[0]), AtsIndex, SC_ATS_BUFF_SIZE);
...
void SC_VerifyAtsEntry_Test_InvalidCmdNumber(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_NUM_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsEntry_Test_BufferFull(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_VerifyAtsEntry((uint32 *)(SC_OperData.AtsTblAddr[AtsIndex]), AtsIndex, 2);

    /* Verify results */
    UtAssert_True(Result == SC_ERROR, "Result == SC_ERROR");

    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_END_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsEntry_Test_InvalidCmdLengthTooLow(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_PKT_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsEntry_Test_BufferOverflow(void)
{
    ...
    /* Execute the function being tested */
    Result = SC_VerifyAtsEntry((uint32 *)(SC_OperData.AtsTblAddr[AtsIndex]), AtsIndex, 20);

    /* Verify results */
    UtAssert_True(Result == SC_ERROR, "Result == SC_ERROR");

    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_BUF_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void SC_VerifyAtsEntry_Test_DuplicateCmdNumber(void)
{
    ...
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventID, SC_VERIFY_ATS_DUP_ERR_EID);
    UtAssert_INT32_EQ(context_CFE_EVS_SendEvent.EventType, CFE_EVS_EventType_ERROR);
...
void UtTest_Setup(void)
{
    ...
    UtTest_Add(SC_BuildTimeIndexTable_Test_InvalidIndex, SC_Test_Setup, SC_Test_TearDown, "SC_BuildTimeIndexTable_Test_InvalidIndex");
    ...
    UtTest_Add(SC_Insert_Test_MiddleOfListCompareAbsTimeTrue, SC_Test_Setup, SC_Test_TearDown, "SC_Insert_Test_MiddleOfListCompareAbsTimeTrue");
    UtTest_Add(SC_Insert_Test_InvalidIndex, SC_Test_Setup, SC_Test_TearDown, "SC_Insert_Test_InvalidIndex");
    UtTest_Add(SC_InitAtsTables_Test_InvalidIndex, SC_Test_Setup, SC_Test_TearDown, "SC_InitAtsTables_Test_InvalidIndex");
    ...
    UtTest_Add(SC_ProcessAppend_Test_InvalidIndex, SC_Test_Setup, SC_Test_TearDown, "SC_ProcessAppend_Test_InvalidIndex");
